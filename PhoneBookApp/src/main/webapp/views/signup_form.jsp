		...
		<form action="${pageContext.request.contextPath}/ContactServlet"
			...
			<div class="form-group">
				Name :-<input type="text" name="username" value=""
					...
					style="background: gainsboro; margin-left: 26px;"
					autofocus="autofocus">
			</div>
			...
			<div class="form-group">
				Email :-<input type="email" name="useremail" value=""
					placeholder="Email"
					style="background: gainsboro; margin-left: 31px;">
			</div>
			<div class="form-group">
				Address:-<input type="text" name="useraddress" value=""
					placeholder="Address"
					style="background: gainsboro; margin-left: 15px;">
			</div>
			<div class="form-group">
				Password:-<input type="password" name="password" value=""
					placeholder="password"
					style="background: gainsboro; margin-left: 5px;">
			</div>
			<input type="hidden" name="id" value=""> <input type="hidden"
				name="action" value="USERADD">
